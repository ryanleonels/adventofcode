...
for script in scripts:
	...
	script1 = (script[0][0] + ' ' + script[1][0] + ' ' + script[2][0] + '\n')
	script1 += (script[0][1] + ' ' + script[1][1] + ' ' + script[2][1] + '\n')
	script1 += (script[0][2] + ' ' + script[1][2] + ' ' + script[2][2] + '\n')
	script1 += (script[0][3] + ' ' + script[1][3] + ' ' + script[2][3] + '\n')
	script1 += 'WALK\n'
	#print(script1)
